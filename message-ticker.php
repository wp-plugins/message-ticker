...
<input name="setting_management" lang="setting_management" class="button-primary" onClick="location.href='options-general.php?page=message-ticker/setting.php'" value="Ticker setting page" type="button" />
    ...
    <ul>
        <li><a target="_blank" href='http://www.gopiplus.com/work/2010/07/18/message-ticker/'>Drag and drop the widget.</a></li>
        <li><a target="_blank" href='http://www.gopiplus.com/work/2010/07/18/message-ticker/'>Add directly in the theme.</a></li>
        <li><a target="_blank" href='http://www.gopiplus.com/work/2010/07/18/message-ticker/'>Short code option for pages/posts.</a></li>
    </ul>
    ...
    <a target="_blank" href='http://www.gopiplus.com/work/2010/07/18/message-ticker/'>Click here</a> to see plugin live demo and help.<br>
  </div>
</div>
<?php
}
...
function mt_control()
{
	...
	<h2><?php echo wp_specialchars( 'About plugin!' ); ?></h2>
	Plug-in created by <a target="_blank" href='http://www.gopiplus.com/work/'>www.gopiplus.com</a>.<br>
	<a target="_blank" href='http://www.gopiplus.com/work/2010/07/18/message-ticker/'>Click here</a> for help.<br>
	<?php
}
...
function mt_widget_init() 
{
	...
	{
		register_widget_control(array('message ticker', 'widgets'), 'mt_control');
	} 
}
