...
{
	add_options_page('Software | Message ticker', 'message ticker', 7, __FILE__, 'mt_admin_options' );
	add_options_page('Software | Message ticker', '', 0, "message-ticker/setting.php",'' );
}
